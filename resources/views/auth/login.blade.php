                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="">
                        ...
                        <div class="form-group{{ $errors->has('login_email') ? ' has-error' : '' }}">
                            <label for="login_email" class="col-md-4 control-label">E-Mail Address</label>

                            <div class="col-md-6">
                                <input id="login_email" type="email" class="form-control" name="login_email" value="{{ old('login_email') }}" required autofocus>
